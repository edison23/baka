...
$edit.keyup(function (e) {
	...
	if (e.keyCode == 9) { //tab
		$(".completion").each(function(index){
			e.preventDefault();
			if ($(this).hasClass("active")){
				// this obviously works incorrectly, since it inserts the suggestion a word earlier
				// error in the functions this relies on
	...
	// probably a problem here, it is supposed to somehow ensure the correct word is replaced
	// and nope, i again dont have much of an idea how it works /edison
