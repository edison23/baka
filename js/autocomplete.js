...
$edit.keyup(function (e) {
  ...
  var isInFocus = false;
    ...
    //console.log(savedRange)
		...
		document.getElementById("editor1").innerHTML = afterSuggestInsert+'</p>';
		// get caret pos
    ...
    var sel = window.getSelection();
    console.log(afterSuggestInsert.length)
    range.setStart(el.childNodes[0], afterSuggestInsert.length);
    range.collapse(true);
    sel.removeAllRanges();
    sel.addRange(range);
